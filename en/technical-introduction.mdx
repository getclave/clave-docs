...
Clave accounts are self-custodial and smart contract based, which means they are fully programmable and modular. Clave Smart Contracts are controlled by the users and secure the funds. Clave Contracts are open-sourced and you can find more information [on our github:](https://github.com/getclave)
